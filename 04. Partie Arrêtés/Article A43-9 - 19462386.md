...
Information permettant d'identifier l'utilisateur.</td>
      <td align="center">
...
demandé avec un minimum de perception de 20 numéros.</td>
      <td align="center">
...
Historique d'attribution d'un numéro d'appel, d'un numéro de carte SIM ou d'un identifiant d'abonné (numéro IMSI).</td>
      <td align="center">
...
les réponses correspondant à une demande.</td>
      <td align="center">
...
l'identification de l'abonné est inclus dans le tarif.</td>
      <td align="center">
...
SIM. Le coût de l'identification de l'abonné est inclus dans le tarif.</td>
      <td align="center">
...
Copie du contrat d'abonnement (fournie sous un mois), forfait indépendant du nombre de pages.</td>
      <td align="center">
...
Copie des documents annexés au contrat d'abonnement (fournie sous un mois), forfait indépendant du nombre de pages.</td>
      <td align="center">
...
Copie de factures (fournie sous un mois), forfait indépendant du nombre de pages.</td>
      <td align="center">
...
Données relatives aux équipements terminaux de communications utilisés.</td>
      <td align="center">
...
Caractéristiques techniques ainsi que date, horaire et durée de chaque communication.</td>
      <td align="center">
...
l'opérateur, sur une période indivisible de 31 jours. L'identification des abonnés est en sus.</td>
      <td align="center">
...
inclut l'identification de la totalité des cellules, l'identification des abonnés est en sus.</td>
      <td align="center">
...
Détail des trafics vers un abonné étranger sur une période indivisible de 31 jours. L'identification de l'abonné est en
sus.</td>
      <td align="center">
...
mois. L'identification des abonnés est en sus.</td>
      <td align="center">
...
au cours des douze derniers mois.</td>
      <td align="center">
...
Données relatives aux services complémentaires demandés ou utilisés par les fournisseurs.</td>
      <td align="center">

MA 72</td>
      <td align="left">

Identification d'un prestataire de services à partir d'un numéro court.</td>
      <td align="center">
...
Recherche de l'adresse d'un relais téléphonique (cellule) à partir de son numéro d'identification.</td>
      <td align="center">
...
Carte de couverture optimale d'une cellule.</td>
      <td align="center">
...
Carte de couverture secondaire d'une cellule.</td>
      <td align="center">
...
Recherche de cellule à partir d'un lieu géographique (couverture optimale théorique).</td>
      <td align="center">
...
Données permettant d'identifier le ou les destinataires de la communication.</td>
      <td align="center">
...
d'un identifiant de téléphone (IMEI).</td>
      <td align="center">
...
sous forme électronique. Prix par numéro demandé. Pour les quantités de 2 à 20 numéros, le prix est celui de 20 numéros.</td>
      <td align="center">
...
techniques de la ligne. Demande reçue sous forme papier, par fax ou sous forme électronique.</td>
      <td align="center">
...
Détail des caractéristiques techniques de la ligne en vue d'une interception, demande copiable sous forme électronique.</td>
      <td align="center">
...
Recherche et identification d'un abonné appelant derrière une tête de ligne ou un serveur.</td>
      <td align="center">
...
Historique d'attribution d'un numéro.</td>
      <td align="center">
...
toutes les réponses correspondant à une demande.</td>
      <td align="center">
...
Identification d'un point de vente à partir d'une carte prépayée.</td>
      <td align="center">
...
Identification d'une carte prépayée et d'un numéro appelé.</td>
      <td align="center">
...
l'abonné est inclus dans le tarif.</td>
      <td align="center">
...
Identification d'un abonné ADSL et de son fournisseur d'accès internet.</td>
      <td align="center">
...
Données relatives aux équipements terminaux utilisés.</td>
      <td align="center">

FA 21</td>
      <td align="left">

Identification des publiphones implantés dans une zone géographique donnée.</td>
      <td align="center">
...
Recherche d'un opérateur tiers à partir de son numéro de faisceau.</td>
      <td align="center">
...
Détail des trafics en relation avec un abonné d'un opérateur étranger sur une période indivisible de 31 jours.</td>
      <td align="center">
...
Détail des données relatives au trafic d'un abonné avec un serveur.</td>
      <td align="center">
...
Détail des données relatives au trafic d'une carte prépayée.</td>
      <td align="center">
...
Interception de communication de lignes fixes.</td>
      <td align="center">
...
Le tarif inclut la fourniture d'un détail de communications en fin d'interception.</td>
      <td align="center">
...
Ligne temporaire de renvoi.</td>
      <td align="center">

FI 10</td>
      <td align="left">

Mise en place et installation d'une ligne analogique temporaire de renvoi ainsi que les abonnements mensuels.</td>
      <td align="center">

84,00 € + 31,85 €</td>
      <td align="center">

120,00 € + 45,50 € par mois</td>
    </tr>
    <tr>
      <td align="center">
...
Installation et enlèvement de la sonde hors ligne de renvoi.</td>
      <td align="center">
...
indivisible de 31 jours : 1,1 × (37,77 € + 0,79 € par km).</td>
      <td align="center">
...
jours : 1,1 × (60,10 € + 0,08 € par km).</td>
      <td align="center">
...
Interception des communications de téléphonie de voix sur IP.</td>
      <td align="center">

FI 23</td>
      <td align="left">

Le tarif inclut la fourniture du détail de trafic pour toute la période d'interception.</td>
      <td align="center">
...
Interception de communication à l'international.</td>
      <td align="center">
...
Interception des communications de téléphonie mobile.</td>
      <td align="center">
...
Non applicable</td>
    ...
    <tr>
      <td align="center">MS 20</td>
      <td align="left">Données permettant d'obtenir la position géographique d'un appareil. Localisation en temps réel des
cellules déclenchées par un téléphone mobile.</td>
...
personne physique, à l'installation, à la connexion, au contrat et aux identifications numériques.</td>
      <td align="center">
...
l'installation, à la connexion, au contrat et aux identifications numériques.</td>
      <td align="center">
...
la connexion, au contrat et aux identifications numériques.</td>
      <td align="center">
...
_Modifié par_:
  ...
  - Arrêté du 4 février 2020 - art. 1 (V)
